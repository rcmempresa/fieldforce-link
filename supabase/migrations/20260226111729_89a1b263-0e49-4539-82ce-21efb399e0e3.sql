...
-- Drop restrictive policies and recreate as permissive for work_orders
...
-- Also fix work_order_equipments so clients can link equipment
...
CREATE POLICY "Anyone can view work order equipments if they can view the work order"
